...
# Mencari nilai minimum dan maksimum dari tensor 2D
# print(tensor.argmin()) # argmin() mengembalikan indeks dari nilai minimum
# print(tensor.argmax()) # argmax() mengembalikan indeks dari nilai maksimum
