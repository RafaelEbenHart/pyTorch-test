...
# Reproducibility
# untuk mengurangi ketidakpastian pada neural network

tensorRandA = torch.rand(3, 4)
tensorRandB = torch.rand(3, 4)

print(tensorRandA)
print(tensorRandB)
print(tensorRandA == tensorRandB)  # mengecek apakah tensor sama

# random namun reproducible tensor
# membuat random seed

# torch.manual_seed(42)
random_seed = 42
torch.manual_seed(random_seed)
tensorRandC = torch.rand(3, 4)

torch.manual_seed(random_seed)
tensorRandD = torch.rand(3, 4)

# seed hanya berfungsi untuk random number generator

print(tensorRandC)
print(tensorRandD)
print(tensorRandC == tensorRandD)  # mengecek apakah tensor sama